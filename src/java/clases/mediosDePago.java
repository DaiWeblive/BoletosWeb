...
public class mediosDePago {
    ...
    public static List<mediosDePago> getListaEnObjetos(String filtro, String orden){
        List<mediosDePago> lista = new ArrayList<>();
        ResultSet datos = mediosDePago.getLista(filtro, orden);
        if(datos!=null){
            try {
                while(datos.next()){
                mediosDePago medioPago = new mediosDePago();
                ...
                Logger.getLogger(mediosDePago.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        return lista;
    }
        ...
        String lista="";
        List<mediosDePago> datos= mediosDePago.getListaEnObjetos(null, "nombre");
        for (int i = 0; i < datos.size(); i++) {
            mediosDePago medioPago = datos.get(i);
            String auxiliar="";
